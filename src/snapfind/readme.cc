...
"            character '*' with a valid and unique filter name before submitting to\n"
"            Diamond. It is recommended not to use all caps for this value.\n"
"\n"
