...
#include "ocv_lowerbody_search.h"
#include "opencv_face_tools.h"
#include "search_set.h"
#include "factory.h"
#include "snapfind_config.h"

#define	SEARCH_NAME	"ocv_lowerbody_search"
#define CLASSIFIER_NAME       "haarcascade_lowerbody"
...
search_init()
{
	ocv_lowerbody_factory *fac;

	fac = new ocv_lowerbody_factory;
	factory_register(fac);
}


ocv_lowerbody_search::ocv_lowerbody_search(const char *name, const char *descr)
...
void
ocv_lowerbody_search::write_config(FILE *ostream, const char *dirname)
{
	save_edits();
...
void ocv_lowerbody_search::write_fspec(FILE *ostream) 
{
	/*
