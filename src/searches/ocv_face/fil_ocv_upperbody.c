...
#include "fil_ocv_upperbody.h"


int
f_init_opencv_ubdetect(int numarg, char **args, int blob_len, void *blob_data,
...
int
f_fini_opencv_ubdetect(void *fdata)
{
...
int
f_eval_opencv_ubdetect(lf_obj_handle_t ohandle, void *fdata)
{
