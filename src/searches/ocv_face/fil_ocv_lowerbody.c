...
#include "fil_ocv_lowerbody.h"


int
f_init_opencv_lbdetect(int numarg, char **args, int blob_len, void *blob_data,
...
int
f_fini_opencv_lbdetect(void *fdata)
{
...
int
f_eval_opencv_lbdetect(lf_obj_handle_t ohandle, void *fdata)
{
