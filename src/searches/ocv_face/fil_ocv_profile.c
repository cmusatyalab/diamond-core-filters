...
#include "fil_ocv_profile.h"

int
f_init_opencv_pdetect(int numarg, char **args, int blob_len, void *blob_data,
...
int
f_fini_opencv_pdetect(void *fdata)
{
...
int
f_eval_opencv_pdetect(lf_obj_handle_t ohandle, void *fdata)
{
