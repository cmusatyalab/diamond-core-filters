...
vj_face_search::write_fspec(FILE *ostream)
{
	...
	fprintf(ostream, "EVAL_FUNCTION  f_eval_detect \n");
	fprintf(ostream, "INIT_FUNCTION  f_init_detect \n");
	fprintf(ostream, "FINI_FUNCTION  f_fini_detect \n");
	...
	if (do_merge) {
	 	fprintf(ostream, "\n");
	 	fprintf(ostream, "FILTER  MERGE  # dependancies \n");
	 	fprintf(ostream, "THRESHOLD  1  # dependancies \n");
	 	fprintf(ostream, "EVAL_FUNCTION  f_eval_bbox_merge  # dependancies \n");
